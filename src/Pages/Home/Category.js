...
const Category = ({category}) => {
    ...
    return (
      //   <div className="card card-compact h-84 bg-base-100 shadow-xl">
  ...
  <div className="card-body">
    ...
    <div className="card-actions mt-16">
      <Link  to={`categories/${category._id}`}><button className="bg-orange-400 hover:bg-orange-300 p-3 rounded-md ">See Category Products</button></Link>
    </div>
  </div>
</div>
    );
