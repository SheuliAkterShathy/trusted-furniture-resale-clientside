...
const Footer = () => {
  return (
    <footer
      style={{
        backgroundImage:
          "url('https://img.freepik.com/premium-photo/delicate-yellow-abstract-watercolor-background_3590-82.jpg?w=1380')",
        backgroundSize: "cover",
      }}
      className="px-4 divide-y mt-20"
    >
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4 m-auto">
      ...
      <div className="py-6 text-sm text-center">
        © 2022 copyrights, Trusted Furniture. All rights reserved.
      </div>
    </footer>
  );
};
