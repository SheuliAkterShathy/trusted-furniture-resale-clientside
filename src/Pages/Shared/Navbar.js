  ...
  const menuItems = (
    <React.Fragment>
      <li>
        <NavLink
          className={({ isActive }) =>
            isActive ? "text-amber-500 underline underline-offset-4" : undefined
          }
          to="/"
        >
          Home
...
<li onChange={handle}>
  ...
  return (
    <div className="navbar flex justify-between m-auto">
      <div className="navbar-start md:mx-">
        ...
        <NavLink
          to="/"
          className="btn btn-ghost normal-case text-xl text-amber-500"
        >
          Trusted Furniture
        </NavLink>
      </div>
